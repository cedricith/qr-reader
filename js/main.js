...
(function(undefined) {
    ...
    var args = {
        ...
        resultFunction: function(res) {
            ...
            var result = res.code.split(", ");
            console.log(result);

            if (result[1] == "monkey") {
                if (document.querySelector("#monkey_step").innerHTML != result[0]) {
                    document.querySelector("#monkey_step").innerHTML = result[0];
                    $('#monkey').addClass('animated bounce');
                    setTimeout(function(){
                        $('#monkey').removeClass('animated bounce');
                    }, 1000);
                }
            } else if (result[1] == "rhino") {
                if (document.querySelector("#rhino_step").innerHTML != result[0]) {
                    document.querySelector("#rhino_step").innerHTML = result[0];
                    $('#rhino').addClass('animated bounce');
                    setTimeout(function(){
                        $('#rhino').removeClass('animated bounce');
                    }, 1000);
                }
            } else if (result[1] == "dog") {
                if (document.querySelector("#dog_step").innerHTML != result[0]) {
                    document.querySelector("#dog_step").innerHTML = result[0];
                    $('#dog').addClass('animated bounce');
                    setTimeout(function(){
                        $('#dog').removeClass('animated bounce');
                    }, 1000);
                }
            }
        },
